...
export const PLUGIN_ID = 'ClawGuard';
export const PLUGIN_NAME = 'ClawGuard';
export const PLUGIN_DESCRIPTION = 'Core-only audit, hardening, and behavior rules for OpenClaw';

export const RULE_BLOCK_START = '<!-- ClawGuard:rules:start -->';
export const RULE_BLOCK_END = '<!-- ClawGuard:rules:end -->';
...
export const DEFAULT_RULES = [
  ...
  'Before trusting new skills, inspect code (install scripts, payloads, dynamic execution) not branding. Scan with `npx openclaw ClawGuard scan-skill` before installation.',
  'After security-relevant changes, re-check with `npx openclaw ClawGuard audit`. Treat unexpected drift in openclaw.json, SOUL.md, or installed skills as actionable signals.',
